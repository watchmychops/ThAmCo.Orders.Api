    ...
    public class OrderContext : DbContext {
        ...
        protected override void OnModelCreating(ModelBuilder builder) {
            ...
            builder.Entity<OrderDetail>().HasData(
                new OrderDetail { Id = 1, OrderId = 1, ProductId = 1, UnitPrice = 10.32m, Quantity = 10 },
                new OrderDetail { Id = 2, OrderId = 1, ProductId = 3, UnitPrice = 200.00m, Quantity = 1 },
                new OrderDetail { Id = 4, OrderId = 2, ProductId = 4, UnitPrice = 22.00m, Quantity = 2 },
                new OrderDetail { Id = 5, OrderId = 2, ProductId = 5, UnitPrice = 50.00m, Quantity = 1 },
                new OrderDetail { Id = 6, OrderId = 3, ProductId = 6, UnitPrice = 35.75m, Quantity = 3 },
                new OrderDetail { Id = 7, OrderId = 3, ProductId = 7, UnitPrice = 18.20m, Quantity = 2 },
                new OrderDetail { Id = 8, OrderId = 3, ProductId = 1, UnitPrice = 10.32m, Quantity = 1 },
                new OrderDetail { Id = 9, OrderId = 4, ProductId = 8, UnitPrice = 42.50m, Quantity = 1 },
                new OrderDetail { Id = 10, OrderId = 5, ProductId = 9, UnitPrice = 55.00m, Quantity = 2 },
                new OrderDetail { Id = 11, OrderId = 5, ProductId = 3, UnitPrice = 200.00m, Quantity = 1 },
                new OrderDetail { Id = 12, OrderId = 6, ProductId = 10, UnitPrice = 60.00m, Quantity = 4 },
                new OrderDetail { Id = 13, OrderId = 7, ProductId = 2, UnitPrice = 15.50m, Quantity = 3 },
                new OrderDetail { Id = 14, OrderId = 7, ProductId = 4, UnitPrice = 22.00m, Quantity = 1 },
                new OrderDetail { Id = 15, OrderId = 7, ProductId = 6, UnitPrice = 35.75m, Quantity = 2 },
                new OrderDetail { Id = 16, OrderId = 8, ProductId = 5, UnitPrice = 50.00m, Quantity = 1 },
                new OrderDetail { Id = 17, OrderId = 8, ProductId = 7, UnitPrice = 18.20m, Quantity = 1 },
                new OrderDetail { Id = 18, OrderId = 9, ProductId = 1, UnitPrice = 10.32m, Quantity = 2 },
                new OrderDetail { Id = 19, OrderId = 9, ProductId = 8, UnitPrice = 42.50m, Quantity = 1 },
                new OrderDetail { Id = 20, OrderId = 9, ProductId = 10, UnitPrice = 60.00m, Quantity = 3 },
                new OrderDetail { Id = 21, OrderId = 10, ProductId = 9, UnitPrice = 55.00m, Quantity = 1 }
            );
